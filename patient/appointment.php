		...
		<div class="row">
			...
			<div class="col-md-10">
				...
				if (isset($_POST['date'])) 
				{
					...
					{
						$query="INSERT INTO appointment(firstname,surname,gender,phone,appointment_date,symtoms,status,date_booked) VALUES('$firstname','$surname','$gender','$phone','$date','$sym','pending',NOW())";
					...
					<div class="row">
						...
						<div class="col-md-6 jumbotron bg-info">
							<form method="POST">
								...
								<input type="text" name="sym" class="form-control" autocomplete="off" placeholder="Enter Symtomps">
